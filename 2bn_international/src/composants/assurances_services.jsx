...
export default function Assurances_services() {
    ...
    const services = [
        {title:'1. Conseil en audit et certification des comptes', 
        ...
        {title:'4. Digitalisation des outils de gestion et de reporting', 
            content:'Implémentation de solutions technologiques pour automatiser les processus financiers et opérationnels ; Développement de tableaux de bord interactifs pour le suivi en temps réel des performances ; Intégration de systèmes de gestion des risques et de conformité.'},
    ];
